...
export const ksExpectations: Map<string, expectation> = new Map([
  ...
  ['.refStr',             [/*'#/properties/refStr',                         */ NodeType.ObjectProperty,             ks.refStr,          '#/$defs/foo', 'refStr'              , 'properties'           ]],
  ['.refObj',             [/*'#/properties/refObj',                         */ NodeType.ObjectProperty,             ks.refObj,          '#/$defs/bar', 'refObj'              , 'properties'           ]],
